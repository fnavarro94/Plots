...
TH1F * hlw_dotP= (TH1F*)flw->Get("dotPLw");
...
hlw_dotP->Scale(0.066*ll_dotP_scale);
...
hs_dotP->SetMinimum(0.5);
hs_dotP->Draw(" hist eX0"); 
hs_dotP->GetXaxis()->SetTitle("Pt #bullet L_{xy}");
hs_dotP->GetYaxis()->SetTitleOffset(1.5);
hs_dotP->GetYaxis()->SetTitle("Eventos");
cs_dotP->Update(); 
