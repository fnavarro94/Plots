...
double ll_InvMass_scale = lumi*0.066/(4000);
...
legend_InvMass->AddEntry(hDY_InvMass,"Z/#gamma*#rightarrow ee","f");
...
hs_InvMass->GetXaxis()->SetTitle("M_{ee} [GeV/c]");
hs_InvMass->GetYaxis()->SetTitleOffset(1.7);
